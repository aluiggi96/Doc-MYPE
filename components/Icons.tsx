...
export const SparklesIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-6 w-6 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6.343 6.343l1.414 1.414m10.286-2.828l-1.414 1.414M12 21v-4M21 12h-4M17.657 17.657l-1.414-1.414M6.343 17.657l1.414-1.414M12 2v4M4.929 4.929l1.414 1.414m11.314 11.314l-1.414 1.414" />
    </svg>
);
